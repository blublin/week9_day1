...
// import entries from "../objectEntries/index"
...
console.log("Insert Data1:", insertData1 + `\n Result: ${insert(table,insertData1)}`)
console.log("Insert Data2:", insertData2 + `\n Result: ${insert(table,insertData2)}`)